...
class OwnerSignup extends Component {
    ...
    render(){
        ...
        let signForm = this.state.showForm? <Form type="owner"/>: null;
        ...
        return (
            ...
            <div className="bg-secondary text-center text-white">
              <div className="col-sm-offset-3 col-lg-6 col-sm-offset-3">
                ...
                <h1 style={{fontWeight:'300',marginTop:'20px',marginBottom: '10px'}}>Owners!! please sign up for HomeAway</h1>
                <h4>Already have an owner account?<Link to='/ownerlogin'>  Login</Link></h4>
            </div>
